...
-- Tiempo de generación: 10-07-2025 a las 13:37:18
...
INSERT INTO `empleados` (`ID`, `NOMBRE`, `PUESTO`, `PROMEDIO`, `ESTATURA`, `FOTO`) VALUES
(1, 'Karla', 'sistemas', '9.00', '1.50', ''),
(2, 'Sara ', 'Sistemas ', '4.00', '5.00', ''),
(3, '', '', '0.00', '0.00', '');
